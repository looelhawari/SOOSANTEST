...
@section('content')
    <div class="modern-page-header">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1>{{ __('product_categories.add_category') }}</h1>
                    <p class="mb-0">{{ __('product_categories.add_category') }}</p>
                </div>
    ...
    <div class="modern-card">
        <div class="modern-card-header">
            <span class="modern-card-title">{{ __('product_categories.add_category') }}</span>
        </div>
        <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="text-center">
                            <img src="https://via.placeholder.com/150" id="icon-preview" class="img-thumbnail" alt="Icon Preview" style="max-width: 150px; max-height: 150px;">
                        </div>
                    </div>
                </div>
                <div class="text-end mt-4">
                    <button type="submit" class="modern-btn">
                        <i class="fas fa-plus me-1"></i> {{ __('product_categories.create_category') }}
                    </button>
                </div>
            </form>
        </div>
    ...
    <script>
        document.getElementById('icon').addEventListener('change', function(event) {
            ...
            if (file) {
                document.getElementById('icon-preview').src = URL.createObjectURL(file);
            }
        });
    </script>
@endsection
