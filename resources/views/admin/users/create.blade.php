...
<style>
    ...
    .dark-mode .modern-card-header h5 {
        color: #F0F0F0;
    }
            ...
            <div class="card-body p-4">
                <form method="POST" action="{{ route('admin.users.store') }}" id="createUserForm">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="modern-form-group">
                                <label for="role" class="modern-label">{{ __('users.role') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="modern-form-group">
                                ...
                                <div class="modern-checkbox">
                                    ...
                                    <label class="form-check-label" for="is_verified">
                                        <strong>{{ __('users.mark_as_verified') }}</strong>
                                        <br>
