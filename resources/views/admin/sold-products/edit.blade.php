            ...
            <div class="card-body p-4">
                <form action="{{ route('admin.sold-products.update', $soldProduct) }}" method="POST" id="editSaleForm">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <div class="modern-form-group">
                                <label for="user_id" class="modern-label">{{ __('sold-products.employee') }} <span class="text-danger">*</span></label>
                                <select class="modern-select @error('user_id') is-invalid @enderror" 
